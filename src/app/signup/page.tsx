    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">Join the golf community</p>
        </div>

        {/* Form */}
        <form onSubmit={handleSignup} className="bg-white rounded-xl shadow-lg p-8 space-y-6 border border-gray-200">
